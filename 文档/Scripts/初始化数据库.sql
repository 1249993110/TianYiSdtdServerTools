...
--创建索引
CREATE INDEX IF NOT EXISTS HomePosition_index ON HomePosition(SteamID);
...
--创建索引
CREATE UNIQUE INDEX IF NOT EXISTS TeleRecord_index ON TeleRecord(SteamID);
...
--创建索引
CREATE UNIQUE INDEX IF NOT EXISTS Goods_index ON Goods(BuyCmd);
